...
export default function OutfitEditorScreen({ navigation, route }) {
  ...
  return (
    <Screen scroll padded withKeyboard>
      ...
      <ActionButton label={existing ? "Сохранить изменения" : "Сохранить образ"} icon="checkmark-outline" onPress={onSave} style={{ marginTop: spacing.lg }} fullWidth />
    </Screen>
  );
}
