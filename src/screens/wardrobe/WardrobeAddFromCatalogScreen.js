              ...
              <Text
                onPress={() =>
                  navigation.navigate(Routes.WardrobeConfirmItem, {
                    draft: createDraftFromTemplate(item.id, catalogId),
                  })
                }
                style={[
                  typography.button,
