      ...
      >
        ...
        <SheetModal visible={menuVisible} onClose={() => setMenuVisible(false)} title="Действия">
          <View style={{ gap: spacing.sm }}>
            ...
            <ActionButton label="Редактировать категории" icon="pricetags-outline" variant="secondary" onPress={() => { setMenuVisible(false); navigation.navigate(Routes.WardrobeManageCategories); }} fullWidth />
